 ...
 * @link     https://openapi-generator.tech
 */
class WalletTransaction implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'amount' => 'string',
        'addresses' => '\Payrobot\Model\AddressDetail[]',
        'timestamp' => 'int'
    ];
     ...
     * Sets amount
     *
     * @param string|null $amount Amount of the transaction:   * `Negative number (< 0)` is a withdrawal   * `Positive number (> 0)` is a deposit
     *
     * @return $this
     */
     ...
     * Sets addresses
     *
     * @param \Payrobot\Model\AddressDetail[]|null $addresses Address(es) involved:   * `payments` address(es) where payment was received   * `withdrawals` address(es) where funds were sent
     *
     * @return $this
     */
     ...
     * Sets timestamp
     *
     * @param int|null $timestamp Timestamp of the transaction expressed in `Unix Timestamp`
     *
     * @return $this
     */
